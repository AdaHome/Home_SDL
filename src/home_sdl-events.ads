package Home_SDL.Events is
   ...
   type SDL_Time is mod 2 ** 32;
   for SDL_Time'Size use 32;
   ...
   type SDL_Window_Event is record
      ...
      Time : SDL_Time; -- In milliseconds, populated using SDL_GetTicks()
   ...
   type SDL_Event_Padding is array (0 .. 55) of Unsigned_8 with
     Convention => C;

   type SDL_Event (Kind : SDL_Event_Kind) is record
      case Kind is
         when others =>
